...
type ServiceDeleteInput struct {
	ID int `json:"id" form:"id" comment:"服务ID" example:"56" validate:"required"` //服务id
}

type ServiceAddHTTPInput struct {
	ID          int64  `json:"id" form:"id" comment:"服务id" example:"62" validate:"required,valid_service_name"`                  //id
	...
	ClientipFlowLimit int    `json:"clientip_flow_limit" form:"clientip_flow_limit" comment:"bs客户端ip限流	" example:"" validate:"min=0"` //bs客户端ip限流
	...
	IpList                 string `json:"ip_list" form:"ip_list" comment:"ip列表" example:"50" validate:"required,valid_ipportlist"`                      //ip列表
	WeightList             string `json:"weight_list" form:"weight_list" comment:"bs权重列表" example:"" validate:"required,valid_weightlist"`              //bs权重列表
...
type ServiceStatOutput struct {
	Today     []int64 `json:"today" form:"today" comment:"今日流量" example:"" validate:""`         //今日
	Yesterday []int64 `json:"yesterday" form:"yesterday" comment:"昨日流量" example:"" validate:""` //昨日
}
